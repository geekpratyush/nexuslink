...
public final class HelpService {
    ...
    private void loadAllTopics() {
        ...
        List<Object[]> topicDefs = List.of(
            ...
            new Object[]{"rest-client",        "REST Client",             "HTTP",             "/com/nexuslink/ui/help/rest-client.md",         List.of("http", "get", "post", "put", "delete", "request", "response", "headers", "body", "auth", "collection runner", "runner", "extract", "chaining", "form-data", "multipart", "binary", "upload", "save response")},
            new Object[]{"kafka-client",       "Kafka Client",            "Messaging",        "/com/nexuslink/ui/help/kafka-client.md",        List.of("producer", "consumer", "topic", "schema registry", "consumer group", "offset", "ksqldb", "tombstone", "headers", "avro", "partition", "replay", "cluster", "broker", "topic config", "lag")},
            ...
            new Object[]{"databases",          "Database Clients",         "Database",        "/com/nexuslink/ui/help/databases.md",           List.of("sql", "jdbc", "redis", "mongodb", "query", "schema", "stored procedure", "dbms_output", "export", "insert statements", "dialect", "oracle", "sql server", "postgres", "mysql", "driver", "grid", "freeze")},
            ...
            new Object[]{"menu-reference",     "Menus & Toolbars",         "General",         "/com/nexuslink/ui/help/menu-reference.md",      List.of("menu", "menus", "toolbar", "file menu", "edit menu", "view menu", "connection menu", "tools menu", "help menu", "submenu", "where is", "what does")},
            new Object[]{"mongodb",            "MongoDB Client",           "Database",        "/com/nexuslink/ui/help/mongodb.md",             List.of("mongo", "mongodb", "bson", "aggregation", "pipeline", "gridfs", "change stream", "mongosh", "shell", "compass", "studio 3t", "tombstone", "schema", "index")},
            new Object[]{"distribution",       "Installing & Updating",    "General",         "/com/nexuslink/ui/help/distribution.md",        List.of("install", "update", "artifactory", "download", "bootstrap", "offline", "version", "upgrade", "deploy")}
        );
